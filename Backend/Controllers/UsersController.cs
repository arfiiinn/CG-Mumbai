...
namespace backend.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(CGDbContext context)
        {
            _context = context;
        }
        ...
        {
            var user = await _context.User.Where(u => u.UserId == id).Select(u => new { u.UserId, u.OTP, u.CorpMail }).FirstOrDefaultAsync();
            //var vuser = new { otp = user.OTP, corpmail = user.CorpMail };
